 ...
 */
@Config
@Autonomous(name="AutoLeftBlueBackDropNew", group = "drive")
//@Disabled
public class AutoLeftBlueBackDropNew extends LinearOpMode {
    /*
    ...
    */
    ...
    AutoLeftBlueBackDropNew.State currentState = AutoLeftBlueBackDropNew.State.STATE_INITIAL;
    int ver = 1;
