...
//@Disabled
public class AutoLeftBlueBackDropV3 extends LinearOpMode {
    /*
...
*/
        traj_STATE_LEFT_POS2_STEP3 = drive.trajectoryBuilder(traj_INITIAL_2.end())
                .lineToLinearHeading(new Pose2d(-39.50,-12, Math.toRadians(-89)))
                .build();
...
*/
        traj_STATE_LEFT_POS3_STEP3 = drive.trajectoryBuilder(traj_INITIAL_3.end())
                .lineToLinearHeading(new Pose2d(-31,0, Math.toRadians(-89)))
                .build();
