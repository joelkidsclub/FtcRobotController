...
//@Disabled
public class AutoRightRedWingV3 extends LinearOpMode {
    /*
    ...
    */
        ...
        while (!isStopRequested() && opModeIsActive() && !done) {
            ...
            switch (currentState) {
                ...
                case STATE_LEFT_POS1_STEP1:
                    ...
                    if (!drive.isBusy()) {
                        currentState = State.STATE_LEFT_POS1_STEP3;//STATE_LEFT_POS1_STEP2;
                ...
                case STATE_LEFT_POS1_STEP3:
                    telemetry.addData("currentState => ", currentState);
                    if (!drive.isBusy()) {
                        currentState = State.STATE_LEFT_POS1_STEP4;//STATE_LEFT_POS1_STEP4;
                        telemetry.addData("nextState => ", currentState);
                ...
                case STATE_LEFT_POS1_STEP6:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        if(!armUp) {
                            ...
                            //runArm(upSpeed, targetLeft - 10, targetRight - 0);
                            armUp = true;
                        }
                ...
                case STATE_LEFT_POS3_STEP2:
                    telemetry.addData("currentState => ", currentState);
                    if (!drive.isBusy()) {
                        currentState = State.STATE_LEFT_POS3_STEP3;//STATE_LEFT_POS3_STEP3;
                        telemetry.addData("nextState => ", currentState);
                ...
                case STATE_LEFT_POS3_STEP6:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        if(!armUp) {
                            runArm(upSpeed, targetLeft - 138, targetRight - 136);
                            //runArm(upSpeed, targetLeft - 10, targetRight - 8);
                            armUp = true;
                        }
                        movePixelBoxToDrop(2.5);
                ...
                case STATE_LEFT_POS4_STEP1:
                    if (!drive.isBusy()) {
                        ...
                        if(!armUp) {
                            runArm(upSpeed, targetLeft - 136, targetRight - 136);
                            //runArm(upSpeed, targetLeft - 10, targetRight-0);
                            armUp = true;
                        }
    ...
    public int initialize(){
        ...
        traj_STATE_LEFT_POS1_STEP4 = drive.trajectoryBuilder(traj_STATE_LEFT_POS1_STEP2.end())
                .lineToLinearHeading(new Pose2d(-50.5,-20, Math.toRadians(-89)))
                .build();

        traj_STATE_LEFT_POS1_STEP5 = drive.trajectoryBuilder(traj_STATE_LEFT_POS1_STEP4.end())
                //.back(85)
                .lineToLinearHeading(new Pose2d(-50.5,75, Math.toRadians(-89)))
                .build();

        traj_STATE_LEFT_POS1_STEP6 = drive.trajectoryBuilder(traj_STATE_LEFT_POS1_STEP5.end())
                //.strafeRight(22)
                .lineToLinearHeading(new Pose2d(-31,86, Math.toRadians(-89)))
                .build();
...
// Position 2
        ...
        traj_STATE_LEFT_POS2_STEP2 = drive.trajectoryBuilder(traj_INITIAL_2.end())
                .lineToLinearHeading(new Pose2d(-41,-15, Math.toRadians(-90)))
                .build();
        ...
        traj_STATE_LEFT_POS2_STEP5 = drive.trajectoryBuilder(traj_STATE_LEFT_POS2_STEP4.end())
                //.back(96)
                .lineToLinearHeading(new Pose2d(-50.5,78, Math.toRadians(-90)))
                .build();
        traj_STATE_LEFT_POS2_STEP6 = drive.trajectoryBuilder(traj_STATE_LEFT_POS2_STEP5.end())
                //.strafeRight(22)
                .lineToLinearHeading(new Pose2d(-24.5,85, Math.toRadians(-90)))
                .build();
...
// Position 3
        ...
        traj_STATE_LEFT_POS3_STEP3 = drive.trajectoryBuilder(traj_STATE_LEFT_POS3_STEP2.end())
                .lineToLinearHeading(new Pose2d(-50.5,-8, Math.toRadians(-90)))
                .build();
        ...
        traj_STATE_LEFT_POS3_STEP6 = drive.trajectoryBuilder(traj_STATE_LEFT_POS3_STEP5.end())
                //.strafeRight(22)
                .lineToLinearHeading(new Pose2d(-18.5,85, Math.toRadians(-90)))
                .build();
