 ...
 */
@Config
@Autonomous(name="AAAAutoRightRedWing", group = "drive")
//@Disabled
public class AutoRightRedWing_Nikhil extends LinearOpMode {
    /*
    ...
    */
    ...
    AutoRightRedWing_Nikhil.State currentState = AutoRightRedWing_Nikhil.State.STATE_INITIAL;
    int ver = 1;
