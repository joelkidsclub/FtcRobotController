...
@Config
@Autonomous(name="ArihantTestAprilTags-DoNotUse", group = "drive")
@Disabled
public class DArihantTestAprilTagsNew extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //start roadrunner code
        drive.followTrajectory(traj1);

        //start april tag code;
        aprilTagCode();
    ...
    public void aprilTagCode() {
        ...
        while (runtime.seconds() < 10 && opModeIsActive()) {
            ...
            if(desiredTag != null && desiredTag.ftcPose.range < 11){
                leftFrontDrive.setPower(0);
            ...
            moveRobot(desiredDrive, strafe, turn);
            //encoderDrive(0.6,  desiredDrive,  desiredDrive, 5.0);
            telemetry.update();
    ...
    */
    ...
    public void encoderDrive(double speed,
        ...
        int newLeftTarget;
        int newRightTarget;
        double     COUNTS_PER_MOTOR_REV    = 537.7 ;    // eg: TETRIX Motor Encoder
