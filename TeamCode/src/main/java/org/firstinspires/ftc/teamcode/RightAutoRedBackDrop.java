...
public class RightAutoRedBackDrop extends LinearOpMode {
    ...
    */
    ...
    RightAutoRedBackDrop.State currentState = RightAutoRedBackDrop.State.STATE_INITIAL;
    int ver = 1;
...
*/
        ...
        traj_STATE_POS2_STEP3 = drive.trajectoryBuilder(traj_STATE_POS2_STEP2.end())
                .lineToLinearHeading(new Pose2d(-30,38, Math.toRadians(-90)))//-27,30 orig; -25, 35 for 6
                .build();
