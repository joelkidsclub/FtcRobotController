 ...
 */
@Config
@Autonomous(name="XBlueBackDropV2", group = "drive")
@Disabled
public class XAutoLeftBlueBackDropV2 extends LinearOpMode {
    /*
...
*/
        traj_STATE_LEFT_POS2_STEP3 = drive.trajectoryBuilder(traj_INITIAL_2.end())
                .lineToLinearHeading(new Pose2d(-39.50,-14, Math.toRadians(-89)))
                .build();
...
*/
        traj_STATE_LEFT_POS3_STEP3 = drive.trajectoryBuilder(traj_INITIAL_3.end())
                .lineToLinearHeading(new Pose2d(-31,2, Math.toRadians(-89)))
                .build();
