 ...
 */
@Config
@Autonomous(name="XAutoLeftBlueWing_DC", group = "drive")
@Disabled
public class XAutoLeftBlueWing_DC extends LinearOpMode {
    /*
    ...
    */
    ...
    XAutoLeftBlueWing_DC.State currentState = XAutoLeftBlueWing_DC.State.STATE_INITIAL;
    int ver = 1;
