 ...
 */
@Config
@Autonomous(name="AutoRightRedBackDropOld", group = "drive")
@Disabled
public class XAutoRightRedBackDropOld extends LinearOpMode {
    /*
    ...
    */
    ...
    XAutoRightRedBackDropOld.State currentState = XAutoRightRedBackDropOld.State.STATE_INITIAL;
    int ver = 1;
