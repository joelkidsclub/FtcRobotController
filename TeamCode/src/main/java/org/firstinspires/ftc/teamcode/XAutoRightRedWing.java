 ...
 */
@Config
@Autonomous(name="XAutoRightRedWing", group = "drive")
@Disabled
public class XAutoRightRedWing extends LinearOpMode {
    /*
    ...
    */
    ...
    XAutoRightRedWing.State currentState = XAutoRightRedWing.State.STATE_INITIAL;
    int ver = 1;
