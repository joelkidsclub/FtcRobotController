 ...
 */
@Config
@Autonomous(name="AutoRightRedWingOld", group = "drive")
@Disabled
public class XAutoRightRedWingOld extends LinearOpMode {
    /*
    ...
    */
    ...
    XAutoRightRedWingOld.State currentState = XAutoRightRedWingOld.State.STATE_INITIAL;
    int ver = 1;
