 ...
 */
@Config
@Autonomous(name="XAutoRightRedWing_DC", group = "drive")
@Disabled
public class XAutoRightRedWing_DC extends LinearOpMode {
    /*
    ...
    */
    ...
    XAutoRightRedWing_DC.State currentState = XAutoRightRedWing_DC.State.STATE_INITIAL;
    int ver = 1;
