 ...
 */
@Config
@Autonomous(name="XYAutoLeftBlueWingDec", group = "drive")
@Disabled
public class XYAutoLeftBlueWingDec extends LinearOpMode {
    /*
    ...
    */
    ...
    XYAutoLeftBlueWingDec.State currentState = XYAutoLeftBlueWingDec.State.STATE_INITIAL;
    int ver = 1;
