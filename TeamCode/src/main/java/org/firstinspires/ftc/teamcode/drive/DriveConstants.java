...
public class DriveConstants {
    ...
    //public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0,
      //      getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
        public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(20, 0, 10, 13.4);
    /*
    ...
    public static double TRACK_WIDTH = 13.558; // in
     ...
     * inches.
     */
    public static double MAX_VEL = 57.7;
    public static double MAX_ACCEL = 57.7;
